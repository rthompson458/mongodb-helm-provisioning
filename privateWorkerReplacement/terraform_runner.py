...
module runs Terraform. Terraform uses the mongodb-chart Helm hooks for logical database management
and lifecycle.sh for storage, lock, and credential-verification work.
