...
class CliTests(unittest.TestCase):
    ...
    def test_public_help_is_customer_facing(self) -> None:
        ...
        self.assertIn("Typical end-user workflows:", help_text)
        self.assertIn("ReplicaSet workflow:", help_text)
        self.assertIn("ShardedCluster workflow:", help_text)
        self.assertIn("Database commands are shared by ReplicaSets and ShardedClusters", help_text)
        self.assertIn("ListReplicaSets", help_text)
        self.assertIn("ListShardedClusters", help_text)
        self.assertIn("ListDatabases RS1", help_text)
        self.assertIn("ListDatabases SC9", help_text)
        self.assertIn("ListDatabaseAccounts RS1 HouseInfo", help_text)
        self.assertIn("ListDatabaseAccounts SC9 HouseInfo", help_text)
        self.assertIn("Inventory across all managed deployments:", help_text)
